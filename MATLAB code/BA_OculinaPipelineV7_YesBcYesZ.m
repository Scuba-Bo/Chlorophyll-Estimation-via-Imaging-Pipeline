...
%% Pipeline Step 6: Universal XYZ Transformation (Water-Corrected -> Standard Observer)
...
%       using the actual spectral reflectances, standard observer, and illuminant.
...
% 1.1 Load Data
% CIE Standard Observer (No headers in the CSV)
...
title('Standard Observer Alignment (Black=True, Red=Water Corrected)');
view(45, 45);
